...
class Character
{
  ...
  /// \brief index of current sound used to play hurt sound
  unsigned int _currentSoundHurt;
  /// \brief index of current sound used to play missed shot sound
...
/// \brief method to get is visibility the character
  ...
  virtual void  showDummy ( bool show );
	/// \brief method shoot
	/// \param distanceWithOtherCaracter distance with enemy
