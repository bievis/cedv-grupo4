...
Ogre::SceneNode* Utilities::put_element_in_scene ( Ogre::SceneManager* sceneMgr, OgreBulletDynamics::DynamicsWorld* world, string name_element )
  {
    Ogre::Entity *entity = sceneMgr->createEntity ( name_element, name_element + string ( ".mesh" ) );
